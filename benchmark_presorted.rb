...
ARRAY_1 = Array.new(10_000) { rand(0...5_000) }.sort
ARRAY_2 = Array.new(10_000) { rand(0...7_500) }.sort
...
Benchmark.ips do |x|
  ...
  x.report("double_elevators_on_sorted") { Intersections.double_elevators_on_sorted(ARRAY_1, ARRAY_2) }
